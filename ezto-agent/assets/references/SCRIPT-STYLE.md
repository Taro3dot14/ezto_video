...
|---|---|---|---|---|
| **B 站**（默认） | 自来熟、有段子、节奏快 | ≤ 30 字 | 3 秒钩子 | 中（5 秒/idea） |
...
>    执行。
>
> 拿到结论后**先按 fail 项改口播稿，再产出 outline**。
